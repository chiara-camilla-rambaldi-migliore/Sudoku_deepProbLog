...
class Sudoku_Net2x2(nn.Module):
    def __init__(self, num_cells, num_symbols):
        super(Sudoku_Net2x2, self).__init__()
...
class Sudoku_Net2x3(nn.Module):
    def __init__(self, num_cells, num_symbols):
        super(Sudoku_Net2x3, self).__init__()
        self.num_cells = num_cells
        self.num_symbols = num_symbols
...
class Sudoku_Net3x3(nn.Module):
    def __init__(self, num_cells, num_symbols):
        super(Sudoku_Net3x3, self).__init__()
        self.num_cells = num_cells
        self.num_symbols = num_symbols
